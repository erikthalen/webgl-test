...
export const getPiece = ({
  ...
  knobsize = 1,
  knobrandom = 0, // 0-1 move the know along its side
  center = { x: 0, y: 0 }, // translate the piece
  resolution = 100, // how many points/side
  precision = 0.0001, // round points to decimal
} = {}) => {
